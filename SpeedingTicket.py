...
if speed_limit <= 0:
        ...
        if driving_speed <= 0:
                print("Invalid input for the driving speed. Please make sure you are entering a positive number greater than 0.")
        elif driving_speed > 0:
                if driving_speed - speed_limit == 0:
                        print("You are not driving! You're car is parked.")
                elif speed_limit - 10 < driving_speed < speed_limit:
